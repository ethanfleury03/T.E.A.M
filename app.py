...
item_entry = st.Page("pages/item_entry.py", title="Stocking", icon=":material/post_add:")

# Outbound-first: scan/take items before admin stocking flows.
nav = st.navigation([home, scanner, inventory, analytics, history, item_entry])
